 ...
 *
 * Copied from http://grepcode.com/file/repo1.maven.org/maven2/org.apache.cxf/cxf-api/2.7.7/org/apache/cxf/common/util/UrlUtils.java#UrlUtils.urlDecode%28java.lang.String%29
 */
public final class UrlUtils {
  ...
  public static String urlDecode(String value, String enc) {
    try {
      ...
      LOG.warning(enc + " encoding can not be used to decode " + value);
    }
    return value;
  }
  ...
  public static String pathDecode(String value) {
    ...
    for (int i = 0; i < RESERVED_CHARS.length; i++) {
      if (value.contains(RESERVED_CHARS[i])) {
  ...
  public static String toQueryString(MultivaluedMap<String, String> queryParams) {
    if (queryParams == null) {
      return null;
    }
